class ChatSession:
    ...
    def send_prompt(self, elements):
        ...
        prompt = (
                ...
                "IMPORTANT: If the elements do not form a valid, recognized chemical compound, respond with EXACTLY this statement:\n"
        ...
        try:
            ...
            expected_error_message = "Status Code: 418. I am not equipped with such information please ask - Mr. Mohit Ryan"
